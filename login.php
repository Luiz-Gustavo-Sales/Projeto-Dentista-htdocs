      ...
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="img/back_login.jpg"  alt="slider"  data-bgposition=" center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
             <!-- LAYER NR. 4 -->
            <div class="tp-caption lfb tp-resizeme scroll" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="login.php" class="btn">Faça seu login</a> </div>
          </li>
        </ul>
      </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <article class="news-post">
                                <form method="post" id="form_login" method="POST" action="http://wise.no-ip.info:1418/Crown/LoginSite.do">
                                        ...
                                        <div class="col-md- ">
                                            <div class="row">
                                                <div class="col-md-12" id="uf" style="display: block;">
                                                    <b>UF</b>
                                                    <br>
                                                    <select id="comboUf" name="usuario.estado.codigo" style="width:10%; padding: 5px; margin: 10px 0 0 0; clear: both;">
