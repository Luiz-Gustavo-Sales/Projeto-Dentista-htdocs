...
<section class="main-banner">
    <div class="login-banner">
		<ul>
          ...
          <li> 
            <!-- MAIN IMAGE --> 
            <img src="images/bk_indique_dentista.jpg"  data-bgposition=" center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
    ...
    <section class="p-t-b-150"> 
      ...
      <div class="container"> 
        ...
        <div class="heading-block">
          <h4>Indique seu dentista</h4>
          <hr>
          <span>A Crown Odonto desenvolve seu programa de credenciamento juntamente com seus clientes, expandindo a rede credenciada de acordo com os locais onde vivem e trabalham os seus beneficiários. Você pode indicar seu dentista particular para ser um credenciado Crown. So precisa preencher o formulário.</span> </div>
        <div class="contact">
              ...
              <div class="row">
                <div class="col-md-6">
                  <ul class="row">
                    <li class="col-sm-12">
                      <label>
                        <input type="text" class="form-control" name="name" id="name" placeholder="*Nome do Dentista ou Clínica">
                      </label>
                    </li>
                    <li class="col-sm-12">
                      <label>
