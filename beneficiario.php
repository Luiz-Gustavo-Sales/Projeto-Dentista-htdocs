								  ...
								  <div class="portfolio-overlay">
									<div class="detail-info">
									  <div class="position-center-center">
										...
										<hr class="balck">
										<span>Crown Odonto</span><div class="opt" onCLick="location.href='dentista.php';">3333 <a href="#" title="RESEARCH CENTER"><i class="fa fa-search"></i></a> </div>
									</div>
								  </div>
								</div>
						  </article>
                        ...
                        <div class="col-md-6">
                            ...
                            <article class="news-post">
                                <form method="post" id="form_login">
                                    <input type="hidden" name="sitenovo" value="7">
